describe AppDetailsScraper do
  ...
  let(:data_hash) { { :app_agent => '',
                      :app_applicant => 'Mr & Mrs R.I.G. Hardcastle, Le Mont Sohier, St. Brelade, JE3 8EA',
  ...
  it '#data_hash returns hash of field names and data' do
    puts scraper.data_hash
    expect(scraper.data_hash) == data_hash
  end
