# describe UprnScraper do
  ...
  # string = 'crabbe'
  # parish_num = 2
  # string_scraper = UprnScraper.new(string)
  # fourneaux = UprnScraper.new('fourneaux') # captures St. Brelade and St. Saviour
  # parish_scraper = UprnScraper.new('fourneaux', 11) # 11 is St. Saviour

  # context '#new' do
  #   it 'returns an instance of the class with no parish number supplied' do
  #     expect(string_scraper.class).to eq(UprnScraper)
  #   end

  #   it 'returns an instance of the class with a parish number supplied' do
  #     expect(parish_scraper.class).to eq(UprnScraper)
  #   end
  # end
  ...
  #     expect(UprnScraper.new('qqqqzq').count).to eq(0)
  #   end

  #   it 'returns 50 (site limit) if 50 or more properties are found' do
  #     expect(UprnScraper.new('fliquet').count).to eq(50)
  #   end
  # end
